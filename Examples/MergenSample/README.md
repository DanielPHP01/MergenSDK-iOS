...
app id `com.mergen.sample.ios`) — приложение запускается сразу.
После истечения (или для своего bundle id) замените `MergenSample/license.json`
на лицензию, выданную вам командой Mergen.
